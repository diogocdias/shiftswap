                                            ...
                                            {swapFormData.myShifts.map((shift, index) => (
                                                <div key={index} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg border border-gray-200">
                                                    ...
                                                    <button
                                                        ...
                                                        className="ml-3 text-red-600 hover:text-red-800 hover:bg-red-50 p-2 rounded transition"
                                                        title="Remove shift"
                                                    >
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                if (selector.value) {
                                                    const [date, shiftType] = selector.value.split('-');
                            ...
                            <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-white rounded-md p-3 border border-blue-200">
                                        <div className="text-xs font-medium text-gray-600 mb-2">You Give</div>
